...
return [
    ...
    'Destroy' => '销毀',
    'Destroy all' => '清空回收站',
    'Nothing need restore' => '沒有需要還原的数据',
    'Drag to sort' => '拖动進行排序',
    'Redirect now' => '立即跳轉',
    'Key' => '键',
    'Value' => '值',
    ...
    'Are you sure you want to delete the %s selected item?' => '确定删除选中的%s項?',
    'Are you sure you want to delete this item?' => '确定删除此項?',
