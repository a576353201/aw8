...
export default {
	...
	socketurl: 'wss://wss.amazon.wealth-mall.com', //如果是ws:// 地址为ws://你服务器IP:7272 如 ws://123.4.56.78:7272，使用wss 后面不需要添加 :7272 端口

	cdnurl: 'https://www.amazon.wealth-mall.com',

	appurl: 'https://www.amazon.wealth-mall.com/api', //如二级域名：https://api.wanlshop.com 或不使用二级域名 https://www.wanlshop.com/api
