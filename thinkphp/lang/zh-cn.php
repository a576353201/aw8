...
return [
    ...
    'not support total'                                         => '簡潔模式下不能獲取數據总數',
    'not support last'                                          => '簡潔模式下不能獲取最后壹頁',
    ...
    'memcache init error'                                       => '未开通Memcache服務，請在SAE管理平台初始化Memcache服務',
    ...
    'delete without condition'                                  => '沒有条件不會執行刪除操作',
    ...
    'directory {:path} creation failed'                         => '目录 {:path} 創建失敗！',
    ...
    ':attribute not a valid datetime'                           => ':attribute不是壹个有效的日期或時間格式',
    ...
    ':attribute out of accord with :2'                          => ':attribute和確认字段:2不壹致',
