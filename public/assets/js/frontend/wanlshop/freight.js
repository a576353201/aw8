                ...
                el: "#app", data: function () {
                    ...
                    initializeForms: function () {
                        ...
                        if (this.forms.forEach(function (t) {
                            e += t.citys.length
                        }), console.log(e), e >= this.cityCount) return layer.msg("已經选择了所有區域~"), !1;
                        var t = this;
                        this.onShowCheckBox({
                            complete: function (e) {
                        ...
                        var t = this;
                        layer.confirm("确定要刪除嗎？", {title: "友情提示"}, function (i) {
                        ...
                        layer.open({
                            ...
                            yes: function (e) {
                                if (r.checked.citys.length <= 0) return layer.msg("请选择區域~"), !1;
