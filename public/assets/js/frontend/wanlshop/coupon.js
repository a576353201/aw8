    ...
    var o = {
            ...
            new i({
                ...
                methods: {
                    ...
                    categoryLink: function() {
                        var e = this;
                        parent.Fast.api.open("wanlshop/shopsort/select?multiple=true", __("选择类目鏈接"), {
                            area: ["800px", "600px"],
                            callback: function(t) {
                                e.range = t.url
                            }
                    ...
                    goodsLink: function() {
                        var e = this;
                        parent.Fast.api.open("wanlshop/goods/select?multiple=true", __("选择商品鏈接"), {
                            area: ["800px", "600px"],
                            callback: function(t) {
                                e.range = t.url
                            }
        ...
        api: {
            formatter: {
                mode: function(e, t, a) {
                    var r = "";
                    return ("reduction" == t.type || "vip" == t.type && "reduction" == t.usertype) && (r = "<span>滿 " + Number(t.limit) + " 元減" + Number(t.price) + "</span>"),
                    ("discount" == t.type || "vip" == t.type && "discount" == t.usertype) && (r = '<span class="text-success">滿 ' + Number(t.limit) + " 元打" + Number(t.discount) + "折</span>"),
                    "shipping" == t.type && (r = '<span class="text-danger">滿 ' + Number(t.limit) + " 元包邮</span>"),
                    r
                },
                ...
                overdue: function(e, t, a) {
                    return "fixed" == t.pretype ? t.enddate: 0 == t.validity ? "長期有效": "領取 " + t.validity + " 天"
                },
